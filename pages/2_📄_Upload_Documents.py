...
st.set_page_config(page_title="Personal Document Assistant - Upload Documents", page_icon="📂")
...
# Sidebar header
st.sidebar.markdown(
    "<h2 style='text-align: center;'>Personal Document Assistant</h2>", unsafe_allow_html=True
)
st.sidebar.markdown(
